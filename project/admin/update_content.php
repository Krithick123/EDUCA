...
if(isset($_POST['update'])){
   ...
   $update_content = $conn->prepare("UPDATE `content` SET title = ?, description = ?, live = ?,  status = ? WHERE id = ?");
   $update_content->execute([$title, $description, $live, $status, $video_id]);
...
<section class="video-form">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <p>update Session  <span>*</span></p>
      <textarea name="live" class="box" required placeholder="Update Sessions Details" maxlength="1000" cols="30" rows="10"><?= $fecth_videos['live']; ?></textarea>
