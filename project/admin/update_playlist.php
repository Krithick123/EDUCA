...
if(isset($_POST['submit'])){
   ...
   $update_playlist = $conn->prepare("UPDATE `playlist` SET title = ?, description = ?, quiz = ?, status = ? WHERE id = ?");
   $update_playlist->execute([$title, $description, $quiz, $status, $get_id]);
...
<section class="playlist-form">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <p>Update Quiz<span>*</span></p>
      <textarea name="quiz" class="box" required placeholder="Enter quiz Details" maxlength="1000" cols="30" rows="10"><?= $fetch_playlist['quiz']; ?></textarea>
