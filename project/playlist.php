   ...
   <div class="row">
      ...
      <div class="col">
         <form action="" method="post" class="save-list">
            ...
            ?>
            <a href="https://forms.gle/J2mbkWkrEaX3afdk6" class="inline-btn">Start Quiz </a>
         </form>
         <div class="thumb">
      ...
      <div class="col">
         ...
         <div class="date"><i class="fas fa-calendar"></i><span><?= $fetch_playlist['date']; ?></span></div>
            ...
            <button class="inline-btn">Course Description</button>
            <p><?= $fetch_playlist['description']; ?></p>
            <a href="#" class="inline-btn" id="qiz">Quiz Details </a>
            <p><?= $fetch_playlist['quiz']; ?></p>
