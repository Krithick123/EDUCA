...
<div class="wrapper">
            ...
            <div class="color">
              ...
              <div class="colors-wrapper">
                <div class="foreground">
                  <span class="headings">foreground</span>
                ...
                <div class="background">
                  <span class="headings">background</span>
                  <div class="custom-picker">
                    <span></span>
                ...
                <div class="corner">
                  <span class="headings">corner</span>
                  <div class="custom-picker">
                    <span></span>
            ...
            <div class="type">
              ...
              <div class="types-wrapper">
                ...
                <div class="corner-squares">
                  <span class="headings">corners squares</span>
                  <div class="custom-dropdown">
                ...
                <div class="corner-dots">
                  <span class="headings">corners dots</span>
                  <div class="custom-dropdown">
      ...
      <div class="container" id="scanner-container">
        ...
        <div class="right">
          <div class="result">
            <p class="headings">Result</p>
            <textarea id="result" disabled></textarea>
            <div class="btns" id="result-btns">
              <button class="btnss" id="copy">
                <i class="fa-solid fa-copy"></i>
                copy
              </button>
              <button class="btnss" id="open">
