...
<section class="watch-video">
   ...
   <div class="video-details">
      ...
      <button  class="inline-btn">Video Description</button>
      ...
      <button  class="inline-btn">Live Sessions Details</button>
        <p><?= $fetch_content['live']; ?></p>
       
      </div>
      <a href="https://meet.google.com/ang-sutd-jcw" class="inline-btn">join Meet </a>
